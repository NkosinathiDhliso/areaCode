...
## ⚠️ Re-verification Notice (June 1, 2026)

**This document is largely STALE.** Every finding below was re-verified against the
live codebase on June 1, 2026. Most items flagged as "missing" had already been built
...
| ----------------------------- | ----------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| C1 Mobile app                 | "Incomplete / non-functional" | **MOSTLY DONE.** Full Expo Router app exists (auth, tabs, map, check-in, QR). Only the push-registration stub (`apps/mobile/src/lib/push.ts`) is genuinely unwired.                              |
