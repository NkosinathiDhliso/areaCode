  ...
  return (
    <Box className="fixed inset-0 z-50 flex flex-col justify-end">
      <Box
        ...
        role="presentation"
      />
      <Box className="relative glass-sheen rounded-t-3xl px-5 pt-5 pb-8 max-h-[85dvh] overflow-y-auto animate-[slideUp_300ms_cubic-bezier(0.2,0.8,0.2,1)_forwards] shadow-[var(--shadow-lg)]">
