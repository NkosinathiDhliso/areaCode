...
function buildMusicFields(
  idx: number,
): Pick<User, 'musicGenres' | 'dimensionScores' | 'archetypeId' | 'streamingProvider'> {
...
export const MOCK_USERS: User[] = [
  ...
  },
  {
    id: 'mock-user-13',
    phone: '+27060000013',
    username: 'siyabonga_d',
    displayName: 'Siyabonga Dube',
    avatarUrl: null,
    cityId: 'jhb',
    neighbourhoodId: null,
    tier: 'local',
